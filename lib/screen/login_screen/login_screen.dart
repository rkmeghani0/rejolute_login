...
class _LoginScreenState extends State<LoginScreen> {
          ...
          return AbsorbPointer(
            ...
            child: Stack(
              children: <Widget>[
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomText(StringResource.SIGN_IN,
                ...
                if (state is LoginLoadingState) LoadingAnimationIndicator()
              ],
            ),
          );
        },
  ...
  Widget buildEmailTextBox() {
    return CustomAppTextField(
        ...
        txtFocus: loginBloc!.emailControllerFocus,
        errorText: loginBloc!.emailErrorText,
        minWidthText: 60,
        txtFormField: TextFormFieldWidget(
          ...
          textColor: ColorResource.PRIMARY,
          focusNode: loginBloc!.emailControllerFocus,
          primaryColor: ColorResource.PRIMARY,
          ...
          inputTextSize: 14,
          onSubmitField: (value) {
            changeFocus(context, loginBloc!.emailControllerFocus,
                loginBloc!.passwordControllerFocus);
          },
        ));
  }
  ...
  Widget buildPasswordTextBox() {
    return BlocBuilder<LoginBloc, LoginState>(
      buildWhen: (LoginState previousState, LoginState currentState) {
        if (currentState is LoginInitialState ||
            currentState is LoginPasswordVisibilityToggleEvent)
          return true;
        else
          return false;
      },
      ...
      builder: (context, state) {
        return CustomAppTextField(
            ...
            txtFocus: loginBloc!.passwordControllerFocus,
            errorText: loginBloc!.passwordErrorText,
            isSuffixicon: true,
            minWidthText: 60,
            txtFormField: TextFormFieldWidget(
              ...
              textColor: ColorResource.PRIMARY,
              focusNode: loginBloc!.passwordControllerFocus,
              primaryColor: ColorResource.PRIMARY,
              textInputType: TextInputType.emailAddress,
              ...
              suffixIcon: loginBloc!.passwordSuffixIcon,
              maxLines: 1,
              suffixIconSize: 20,
    ...
    //       color: ColorResource.GREY_PALE_F2F4F8,
    //       border: Border(
    //         bottom: (loginBloc.passwordControllerFocus.hasFocus)
  ...
  onTogglePasswordPressed() {
    loginBloc!.add(LoginPasswordVisibilityToggleEvent());
  }
